...
/mpc/target/release/examples/gg18_sm_manager &
...
do
    ...
    /mpc/target/release/examples/gg18_keygen_client http://127.0.0.1:8001 keys$i.store &
    sleep 3
done
...
do
    ...
    /mpc/target/release/examples/gg18_sign_client http://127.0.0.1:8001 keys$i.store "KZen Networks" &
    sleep 3
done
